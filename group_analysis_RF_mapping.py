...
shared_analysis.plotAllResponsesByCondition_RF_mapping(mapping_IDs, ch_names=['mask_ch1','mask_ch2'], response_set_name = 'mask', condition='angle', roi_prefix='aligned')
